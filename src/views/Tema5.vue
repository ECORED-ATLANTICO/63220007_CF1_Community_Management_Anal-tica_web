...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    p.mb-4 La interacción en redes sociales se refiere a la participación de los usuarios con el contenido publicado por una marca, empresa o creador digital. Este concepto abarca acciones como comentarios, reacciones, compartidos y conversaciones dentro de la plataforma, convirtiéndose en un factor esencial para medir el impacto y la relevancia de una estrategia digital. La interacción es clave para fortalecer la relación entre una marca y su audiencia, sus beneficios incluyen:

    .row.justify-content-center.align-items-center
      .col-10.col-lg-4
        figure
          img.mb-4.mb-lg-0(data-aos="fade-up")(src='@/assets/curso/temas/tema5/1.png', alt='imagen decorativa')
      .col-lg-8
        LineaTiempoD.color-secundario.custom-timeline
          .row(numero="1" titulo="Generación de confianza")
            p.text-small Una comunicación activa y transparente fomenta credibilidad y lealtad hacia la marca.

          .row(numero="2" titulo="Fidelización de audiencia")
            p.text-small La interacción frecuente fortalece el vínculo emocional entre los usuarios y la marca.

          .row(numero="3" titulo="Conversión y <em>engagement</em>")
            p.text-small Una mayor participación incrementa las probabilidades de convertir usuarios en clientes o seguidores.
    ...
    #t_5_1(data-aos='zoom-in-right').titulo-segundo.color-secundario.z-2
      h3 5.1.	Principios
    ...
    #t_5_2(data-aos='zoom-in-right').titulo-segundo.color-secundario.z-2
      h3 5.2.	Fomento
    ...
    #t_5_3(data-aos='zoom-in-right').titulo-segundo.color-secundario.z-2
      h3 5.3.	Medición de participación
    ...
    .row.justify-content-center.align-items-center.z-2
      .col-8.col-sm-6.col-xl-4.d-none.d-xl-block
        figure
          img.mb-4.mb-lg-0(data-aos="fade-down")(src='@/assets/curso/temas/tema5/5.png', alt='Imagen decorativa')
      .col-xl-8
